...
namespace BookATable.Helpers
{
    public class HashUtils
    {
        ...
        public static int ConvertCustomIdToInt(string newId)
        {
            MD5 md5Hasher = MD5.Create();
            var hashed = md5Hasher.ComputeHash(Encoding.UTF8.GetBytes(newId));
        ...
        public static string GetRandomString(int length)
        {
            ...
            {
                "0", "2", "3", "4", "5", "6", "8", "9", "a", "b", "c", "d", "e", "f", "g", "h", "j", "k", "m", "n", "p",
                "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"
            };
